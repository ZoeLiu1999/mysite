...
```shell
git clone https://github.com/ZoeLiu1999/mysite
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/mysite/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://ZoeLiu1999.github.io/mysite'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/ZoeLiu1999/mysite
  - link: https://github.com/ZoeLiu1999/mysite#readme
...
`https://ZoeLiu1999.github.io/mysite`